    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
        ...
        <form onSubmit={handleCreateAd} className="nt-8 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                <ToggleGroup.Item
                  value="0"
                  title="Domingo"
                  className={`h-8 w-8 rounded bg-zinc-900 ${weekDays.includes('0') ? 'bg-violet-500' : ''}`}
                >
                  D
                </ToggleGroup.Item>
                <ToggleGroup.Item
          ...
          <label className="nt-2 flex items-center gap-2 text-sm">
            <Checkbox.Root
          ...
          <footer className="nt-2 flex justify-end gap-4">
            <Dialog.Close
              type="button"
